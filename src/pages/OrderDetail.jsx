        ...
        <div className="flex  justify-between">
          <div className="flex flex-col gap-4">
            <div className="flex gap-10">
              <h1 className="text-[24px] font-semibold">Orders ID: #6743</h1>{" "}
              <div className="flex  rounded-xl justify-center items-center font-semibold w-[71px] h-[32px] text-[12px] bg-[#FFA52F]">
                Pending
              </div>{" "}
            </div>
            <span className="flex gap-2">
              {" "}
              <IoCalendarOutline className="text-[24px] mt- cursor-pointer" />{" "}
          ...
          <div className="flex gap-4">
            ...
            <button className="bg-[#F4F2F2] w-[58px] h-[52px] rounded-xl flex justify-center items-center">
              <HiOutlinePrinter className="text-[28px]" />
            </button>
            <button className="bg-[#F4F2F2] w-[58px] h-[52px] text-[14px] font-semibold rounded-xl flex justify-center items-center">
              Save
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <div className="border-[0.1389vw] mt-9 w-[348px] h-[194px] rounded-xl p-5">
            <div className="flex gap-3">
              <span className=" w-[56px] h-[56px] bg-[#232321] flex items-center justify-center rounded-xl ">
                <IoPersonOutline className="text-white text-[28px]" />
              </span>

              <div className=" leading-8 ">
                <h1 className="text-[1.38vw] font-semibold">Customer</h1>
            ...
            <button className="bg-[#003F62] text-white w-full rounded-md">
              View profile
            </button>
          </div>
          ...
          <div className="border-[0.1389vw] mt-9 w-[348px] h-[194px] rounded-xl p-5">
            <div className="flex gap-3">
              <span className=" w-[56px] h-[56px] bg-[#232321] flex items-center justify-center rounded-xl ">
                <IoBagHandleOutline className="text-white text-[28px]" />
              </span>
        ...
        <div className="flex gap-4 mt-7  ">
          <div className="leading-7 border-[0.1389vw] w-[348px] h-[154px] rounded-xl p-5  ">
            ...
            <span className="flex gap-4">
              {" "}
              <img src={image} className="w-[46px] h-[25px]" alt="" />{" "}
              <p className="text-[#70706E]">Master Card **** **** 6557</p>
            </span>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <label htmlFor="" className="absolute mt-14 pl-5 text-[#70706E]">
              Type some notes
            </label>
            <input
              type="text"
              className="w-[712px] h-[120px] border-[0.1389vw] border-[#E7E7E3] pl-4 outline-none bg-transparent rounded-xl "
            />
          </div>
        </div>
